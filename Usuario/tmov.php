...
<td align='center' colspan="1"><img src="<?php If($result > 0){ echo $acaminho; } else { echo $inposition;}?>" width="40" height="40"></td><td align='center' colspan="8"><b>(<?php echo $count; ?>)<?php If($result > 0){ If($type=="atk"){echo"<b>Attack</b>";} If($type=="ref"){echo"<b>Reinforcement</b>";}} else { echo" <font color='green'>Troops in position</font>";}?></b></td></tr><tr>
...
<td align='center' colspan="9"><b><?php If($result > 0){ echo"Time Remaining:".StoH($result); } else { } ?></b></td></tr><tr>
<td align="center" colspan="9"><?php If($result > 0){} else { }?></td></tr><tr>
...
<td align='center' colspan="9"><b><?php If($result20 > 0){ echo"Time Remaining:".StoH($result20); } else {} ?></b></td></tr><tr>
<td align='center'><?php echo $$nomet1; ?></td><td align='center'><?php echo $$nomet2; ?></td><td align='center'><?php echo $$nomet3; ?></td><td align='center'><?php echo $$nomet4; ?></td><td align='center'><?php echo $$nomet5; ?></td><td align='center'><?php echo $$nomet6; ?></td><td align='center'><?php echo $$nomet7; ?></td><td align='center'><?php echo $$nomet8; ?></td><td align='center'><?php echo $$nomet9; ?></td></tr><tr>
...
<td align='center' colspan="9"><b></b></td></tr><tr>
<td align='center'><?php echo $$nomet1; ?></td><td align='center'><?php echo $$nomet2; ?></td><td align='center'><?php echo $$nomet3; ?></td><td align='center'><?php echo $$nomet4; ?></td><td align='center'><?php echo $$nomet5; ?></td><td align='center'><?php echo $$nomet6; ?></td><td align='center'><?php echo $$nomet7; ?></td><td align='center'><?php echo $$nomet8; ?></td><td align='center'><?php echo $$nomet9; ?></td></tr><tr>
...
<td align='center' colspan="9"><b><?php If($result44 > 0){ echo"Time Remaining:".StoH($result44); } else { } ?></b></td></tr><tr>
<td align="center" colspan="9"><?php If($result44 > 0){} else {}?></td></tr><tr>
<td align='center'><?php echo $$nomet1; ?></td><td align='center'><?php echo $$nomet2; ?></td><td align='center'><?php echo $$nomet3; ?></td><td align='center'><?php echo $$nomet4; ?></td><td align='center'><?php echo $$nomet5; ?></td><td align='center'><?php echo $$nomet6; ?></td><td align='center'><?php echo $$nomet7; ?></td><td align='center'><?php echo $$nomet8; ?></td><td align='center'><?php echo $$nomet9; ?></td></tr><tr>
