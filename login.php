...
<a href="cadastro.php"><img src="img/register.png"></a><br>
...
<br>
<input type="image" src="img/login.png" name="logar" value="LOGIN" id="logar" onclick="this.form.target='_parent';return true;"/>
<br>
